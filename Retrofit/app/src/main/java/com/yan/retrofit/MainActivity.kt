...
import com.yan.retrofit.data.model.Tarefa
import com.yan.retrofit.util.Network
import com.yan.retrofit.domain.TarefaService
...
class MainActivity : AppCompatActivity(), TarefaAdapterListener {
    ...
    override fun excluirTarefa(tarefa: com.yan.retrofit.Tarefa) {
